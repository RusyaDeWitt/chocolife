      ...
      <div class="new">
        ...
        <div class="cards">
          ...
          <div class="card__item">
            <div class="card" 
              style="
                background-image: url('https://static.chocolife.me/static/upload/images/deal/for_deal_page/57000/56887/340x158/20220930089216336f9bd6f7a5.webp?1671262616'); 
            ">
              <div class="card__head">
              <div class="card__tag">
                <img src="../images/map_point.png" width="20px" height="20px"/>
                <span>Абая-Абылайхана</span>
              </div> 
            ...
            <div class="card__info">
              <h4>20 января! Билеты на спектакль «Ищите женщину»</h4>
              <h5>НРТД им. Лермонтова · 2 покупки</h5>
              <div class="card__subinfo">
                <div class="card__review">
                  <img src="../images/star.png" />
                  <h5>4.5/488 отзывов</h5>
                </div>
